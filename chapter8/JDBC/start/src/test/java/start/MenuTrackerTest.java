...
public class MenuTrackerTest {
    ...
    /**
     * Object for deploy and drop database at server.
     */
     ...
     * @throws SQLException if problem with access or connection or statement already closed.
     */
    @Test
    public final void whenRemoveItemFromTrackerShouldRemoveItem() throws SQLException {
        /** Assign block
         Which command will execute - see variable answer
         0 - key for add operation
        ...
        assertThat(stubIO.getOut(), containsString("Deleted item: 1\n"));
    }
