...
public class WinChecker {
    ...
    public boolean isWinner(Player player, Board board) {
        return this.checkHorizontal(player, board)
                ||
                this.checkVertical(player, board)
                ||
                this.checkDiagonal(player, board)
                ||
                this.checkOtherDiagonal(player, board);
    }
